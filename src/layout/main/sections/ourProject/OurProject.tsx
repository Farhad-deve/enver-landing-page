    ...
    <>
        <section className='px-section flex flex-col gap-2r'>
            ...
            <div className='relative'>
                <picture>
                    <source media="(min-width: 768px)" srcSet="/public/assets/images/desktop/our-project-desktop.png" />

                    <img src="/public/assets/images/mobile/our-project-mobile.png" alt="Our Project" className='w-full' />
                </picture>
                ...
                <div className='absolute w-full h-full flex justify-center items-center top-0 left-0'>
                    <button className={`bg-light-blue border-none rounded-full flex justify-center items-center p-1r md-p-2-5r transition-a-03s-ease ${styles.btnPlay}`}>
                        <img src="/public/assets/icons/button-play.svg" alt="Play Button" />
                    </button>
                </div>
            </div>
        </section>
