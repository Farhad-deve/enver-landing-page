    ...
    <>
      <section className="px-section py-section relative flex flex-col gap-2r overflow-hidden md-flex-row md-items-center md-justify-between min-h-screen">
        ...
        <div className="flex flex-col items-start gap-1-5r">
          <h1 className={`text-white font-f-i-s ${styles.heroTitle}`}>
            Build Your Awesome Platform
          </h1>
          <p className={`text-white-70 font-f-n-s ${styles.heroDescription}`}>
        ...
        <div className="relative">
          <div>
            ...
            <div className="relative">
              ...
              <img src="/public/assets/images/desktop/purple-square-bg-desktop.svg" alt="" className="absolute" />
